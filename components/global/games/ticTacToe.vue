      ...
      <v-container fluid>
        <v-row>
          <v-btn
            ...
            height="100px"
            width="100px"
            :style="{backgroundImage: backgrounds['button1']}"
            @click="move('button1')"
          />
          <v-btn
            id="game-button-2"
            ...
            height="100px"
            width="100px"
            :style="{backgroundImage: backgrounds['button2']}"
            @click="move('button2')"
          />
          <v-btn
            id="game-button-3"
            ...
            height="100px"
            width="100px"
            :style="{backgroundImage: backgrounds['button3']}"
            @click="move('button3')"
          />
        </v-row>
        <v-row>
          <v-btn
            ...
            height="100px"
            width="100px"
            :style="{backgroundImage: backgrounds['button4']}"
            @click="move('button4')"
          />
          <v-btn
            id="game-button-5"
            ...
            height="100px"
            width="100px"
            :style="{backgroundImage: backgrounds['button5']}"
            @click="move('button5')"
          />
          <v-btn
            id="game-button-6"
            ...
            height="100px"
            width="100px"
            :style="{backgroundImage: backgrounds['button6']}"
            @click="move('button6')"
          />
        </v-row>
        <v-row>
          <v-btn
            ...
            height="100px"
            width="100px"
            :style="{backgroundImage: backgrounds['button7']}"
            @click="move('button7')"
          />
          <v-btn
            id="game-button-8"
            ...
            height="100px"
            width="100px"
            :style="{backgroundImage: backgrounds['button8']}"
            @click="move('button8')"
          />
          <v-btn
            id="game-button-9"
            ...
            height="100px"
            width="100px"
            :style="{backgroundImage: backgrounds['button9']}"
            @click="move('button9')"
          />
        </v-row>
        <v-row>
...
export default {
  ...
  methods: {
    ...
    getButtonBackground () {
      if (this.currentPlayer === playerX) { return playerXBackground } else if (this.currentPlayer === playerO) { return playerOBackground } else { return notPlayedBackground }
    },
    handleEndGame () {
